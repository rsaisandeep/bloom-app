    ...
    <div style={{ minHeight: '100vh', padding: '4px 16px 24px' }}>
      <div className="anim-rise" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
        <div>
          ...
          <p style={{ margin: '2px 0 0', fontSize: 13, color: '#8A6A9A' }}>Insights for {meta.label} · Day {dayOfCycle}</p>
        </div>
              ...
              return (
                <div key={i} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                  ...
                  <div style={{
                    ...
                    background: isPred
                      ? 'linear-gradient(180deg,#A56ABD,#6E3482)'
                      : 'rgba(165,106,189,0.28)',
